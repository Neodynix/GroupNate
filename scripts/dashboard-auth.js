...
if (!window.supabase) {
    console.error("CRITICAL ERROR: Supabase CDN did not load. Check your internet or adblocker.");
}
...
// This runs automatically whenever a user logs in, logs out, or loads the page
...
// ==========================================
// WAIT FOR HTML TO LOAD BEFORE ATTACHING EVENTS
// ==========================================
document.addEventListener("DOMContentLoaded", () => {
    console.log("HTML Loaded. Attaching Form Listeners...");

    // 1. Initial Session Check (Failsafe)
    ...
    // 2. Auth Form (Login/Signup) Listener
    ...
    if (authForm) {
        ...
        console.error("Could not find the authForm element!");
    }

    // 3. Post Group Form Listener
    const submitGroupForm = document.getElementById('submitGroupForm');
    if (submitGroupForm) {
        submitGroupForm.addEventListener('submit', async function(e) {
...
// ==========================================
// GLOBAL CRUD FUNCTIONS (Must be attached to window)
// ==========================================
